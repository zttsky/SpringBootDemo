package com.nugget.heartbeat.heart;


import com.nugget.heartbeat.init.HeartbeatInitializer;
...
public class HeartBeatServer {
    ...
    @Autowired
    HeartbeatInitializer  heartbeatInitializer;
    ...
    public void start() throws InterruptedException {
        ServerBootstrap bootstrap = new ServerBootstrap()
                ...
                .childHandler(heartbeatInitializer);
        //绑定并开始接受传入的连接。
